	...
	return (
		<>
			...
			<div className="mt-6 flex flex-col">
				<div className="flex flex-col justify-between gap-4 border-b border-r-zinc-200 pb-5 lg:flex-row lg:items-center dark:border-zinc-700">
				...
				>
					<div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
						...
						<div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
							...
							<div className="flex flex-col gap-3 lg:block">
								...
								<Input.Root>
									<Input.Control id="lastName" defaultValue="Lucas" />
								</Input.Root>
							</div>
						</div>
					</div>
					<div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
						...
						<Input.Root>
							...
							<Input.Control id="email" type="email" defaultValue="pedro.lucas4431@gmail.com" />
						</Input.Root>
					</div>
					...
					<div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
						...
						<Input.Root>
							<Input.Control id="role" defaultValue="PEDRO" />
						</Input.Root>
					</div>
